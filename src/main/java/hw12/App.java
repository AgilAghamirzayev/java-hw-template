...
//        familyController.createNewFamily(father4,mother4);
        ...
        familyController.bornChild(familyController.getFamilyById(0),"masculine");  // gender is : feminine or masculine
...
//        familyController.displayAllFamilies();
        ...
        //System.out.println(familyController.getFamilyById(1).showChild());
